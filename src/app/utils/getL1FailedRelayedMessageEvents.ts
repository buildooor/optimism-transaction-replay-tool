...
export async function getL1FailedRelayedMessageEvents (l1ChainId: number, msgHash: string) {
  if (!msgHash) {
    return []
  }
  console.log('getL1FailedRelayedMessageEvents')
  ...
  console.log('done getL1FailedRelayedMessageEvents', logs.length)
  return logs
}
