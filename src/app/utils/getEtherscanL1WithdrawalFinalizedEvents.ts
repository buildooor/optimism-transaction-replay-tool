...
export async function getEtherscanL1WithdrawalFinalizedEvents (l1ChainId: number, withdrawalHash: string) {
  if (!withdrawalHash) {
    return []
  }
  console.log('getEtherscanL1WithdrawalFinalizedEvents')
